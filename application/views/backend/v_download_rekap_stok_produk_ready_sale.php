...
header("Content-Disposition: attachment; filename=Rekap_Data_Stok_Produk_Ready_Sale.xls");
...
<html>
    ...
    <body>
    									<h2>Rekap Data Stok Produk Ready Sale <?php echo format_indo(date("Y-m-d")); ?></h2>
										<table id="mytable" class="display table" style="width: 100%; cellspacing: 0;">
                                            ...
                                            <?php 
                                                ...
                                                foreach ($data->result() as $row):
													...
													$tgl_detail = format_indo(date($row->tgl_ubah));
                                            ?>
                                                <tr>
                                                    <td><?php echo $no;?></td>
