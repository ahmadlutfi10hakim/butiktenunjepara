                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                        <a  id="btn-filter1" data-bs-toggle="tab" href="#home2" role="tab" aria-controls="home2" aria-selected="true"><h6 class="text-muted font-semibold"><b><i class=""></i>Bahan Produksi</b></h6></a>
                                    </ul>
                        ...
                        <div class="card-body px-1 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6">
                                    <input type="hidden" id="kategori_material1">
                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                        <a  id="btn-filter2"  data-bs-toggle="tab" href="#home2" role="tab" aria-controls="home2" aria-selected="true"><h6 class="text-muted font-semibold"><b><i class=""></i>Bahan Tekstil</b></h6></a>
                                    </ul>
                        ...
                        <div class="card-body px-1 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6">
                                    <input type="hidden" id="kategori_material1">
                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                        <a id="btn-filter3" data-bs-toggle="tab" href="#home2" role="tab" aria-controls="home2" aria-selected="true"><h6 class="text-muted font-semibold"><b><i class=""></i>Alat Produksi</b></h6></a>
                                    </ul>
                        ...
                        <div class="card-body px-1 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6">
                                    <input type="hidden" id="kategori_material1">
                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                        <a id="btn-filter4" data-bs-toggle="tab" href="#home2" role="tab" aria-controls="home2" aria-selected="true"><h6 class="text-muted font-semibold"><b><i class=""></i>Kemasan Produk</b></h6></a>
                                    </ul>
                        ...
                        <div class="card-body px-1 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6">
                                    <input type="hidden" id="kategori_material1">
                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                        <a id="btn-filter5" href="#home2"><h6 class="text-muted font-semibold"><b><i class=""></i>Produk Siap Jual</b></h6></a>
                                    </ul>
...
$(document).ready(function() {
    ...
    $('#btn-filter1').click(function(){ 
        var kat1 = 'Material Bahan Produksi';
    ...
    $('#btn-filter2').click(function(){ 
        var kat2 = 'Material Bahan Tekstil';
    ...
    $('#btn-filter3').click(function(){ 
        var kat3 = 'Material Alat Produksi';
    ...
    $('#btn-filter4').click(function(){ 
        var kat4 = 'Material Kemasan Produk';
