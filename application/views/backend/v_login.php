...
<div class="row h-100">
    ...
    <div class="col-lg-5 col-12">
        ...
        <div id="auth-left">
            ...
            <p class="auth-subtitle mb-5 display-4">Halaman Login Sebagai Admin <?php echo $site_title; ?></p>
  ...
  if (x.type === "password") {
    ...
    x.type = "password";
            ...
            <div class="text-center mt-5 text-lg fs-10">
                <p>Untuk login sebagai Karyawan, klik di bawah ini</p>
            </div>
            <div class="text-center text-lg fs-4">
                <p><a class='font-bold  ' href="<?php echo site_url('login_user');?>">Login Sebagai Karyawan</a>.</p>
            </div>
