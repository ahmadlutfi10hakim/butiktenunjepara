...
<!--------------------------------------------------------------------------------------------------->
            ...
            <li class="sidebar-item <?php echo $this->uri->segment(2) == 'warehouse' ? 'active': '' ?>">
                <a href="<?php echo site_url('backend/warehouse');?>" class='sidebar-link'>
            ...
            <li class="sidebar-item <?php echo 
                        ...
                        $this->uri->segment(2) == 'tambah_stock_bahan' ? 'active': '' ||
                        $this->uri->segment(2) == 'produksi_barang' ? 'active': '' ||
                        $this->uri->segment(2) == 'surat_jalan' ? 'active': '' ||
                        $this->uri->segment(2) == 'retur_barang_ekspedisi' ? 'active': ''
                ...
                <ul class="submenu ">
                    ...
                    <li class="submenu-item <?php echo $this->uri->segment(2) == 'tambah_stock_bahan' ? 'active': '' ?>">
                        <a href="<?php echo site_url('backend/tambah_stock_bahan');?>">Tambah Stok Bahan</a>
                    </li>
            ...
            <li class="sidebar-item <?php echo 
            $this->uri->segment(2) == 'transaksi' ? 'active': '' ||
            $this->uri->segment(2) == 'preorder_barang' ? 'active': '' ||
            $this->uri->segment(2) == 'pengeluaran' ? 'active': '' 
            ?> has-sub">
    <a href="#" class='sidebar-link'>
    ...
    <ul class="submenu ">
        <li class="submenu-item <?php echo $this->uri->segment(2) == 'transaksi' ? 'active': '' ?>">
            <a href="<?php echo site_url('backend/transaksi');?>">Penjualan</a>
        </li>
        <li class="submenu-item <?php echo $this->uri->segment(2) == 'preorder_barang' ? 'active': '' ?>">
            <a href="<?php echo site_url('backend/preorder_barang');?>">Pemesanan</a>
        </li>
        <li class="submenu-item <?php echo $this->uri->segment(2) == 'pengeluaran' ? 'active': '' ?>">
            ...
            <li class="sidebar-item <?php echo 
                        ...
                        $this->uri->segment(2) == 'download_rekap' ? 'active': ''
                ...
                <ul class="submenu ">
                    ...
                    <li class="submenu-item <?php echo $this->uri->segment(2) == 'rekap_tim_produksi' ? 'active': '' ?>">
                        <a href="<?php echo site_url('backend/rekap_tim_produksi');?>">Rekap Produksi</a>
                    </li>
            ...
            <li class="sidebar-item <?php echo 
                ...
                <ul class="submenu ">
                    <li class="submenu-item <?php echo $this->uri->segment(2) == 'detail_website' ? 'active': '' ?>">
                        <a  href="<?php echo site_url('backend/detail_website');?>">Edit Detail Website</a>
                    </li>
