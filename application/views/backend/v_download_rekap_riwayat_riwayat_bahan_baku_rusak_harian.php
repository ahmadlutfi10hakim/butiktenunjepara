...
header("Content-Disposition: attachment; filename=Rekap_Data_Bahan_Baku_Rusak_Harian.xls");
...
<html>
    ...
    <body>
    									<h2>Rekap Data Bahan Baku Rusak <?php echo format_indo(date("Y-m-d")); ?></h2>
