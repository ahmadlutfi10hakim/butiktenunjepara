...
<!-- MODAL -->
        <!-- Add Records Modal -->
        <div class="modal fade text-left" id="modal_form_stockproduksi" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body form">
                        ...
                        <?php
                            $attributes = array('class' => 'form-horizontal', 'id' => 'formstockproduksi');
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-4">
                                <div class="form-group">
                                    <label for="valid-state">Nama Produk</label>
                                    <input type="text" name="nama_stock" class="form-control nama_stock" id="nama_stock" placeholder="Nama Produk">
                                ...
                                <div class="form-group">
                                    <input type="hidden" name="kategori_material" value="Product Ready Sale" id="kategori_material">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-success ml-1 btnSave" id="btnSave" onclick="addstockproduksi()">
