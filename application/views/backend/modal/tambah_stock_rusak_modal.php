...
<!-- MODAL -->
        <!-- Add Records Modal -->
        <div class="modal fade text-left" id="modal_form_rusak" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body form">
                        ...
                        <?php
                            $attributes = array('class' => 'form-horizontal', 'id' => 'formrusak');
                        ...
                        <div class="row">
                            ...
                            <input type="hidden"  name="kode_produksi" class="kode_produksi" value="<?php echo $id; ?>"/> 
                            ...
                            <div class="col-12">
                                ...
                                <div class="form-group">
                                    <label for="valid-state">Jumlah Material Rusak</label>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-success ml-1 btnSave" id="btnSave" onclick="addrusak()">
